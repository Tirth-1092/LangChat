...
SECRET_KEY = 'django-insecure-es--v#iybo_uo@fvc)i56!&5qo9qv5lb(%9s0@kv_ejt*$79ys'
...
# Tell Django to use ASGI
ASGI_APPLICATION = 'LangChat.asgi.application'
...
DJOSER = {
    ...
    'SERIALIZERS': {
        ...
        # you can leave 'user' pointing at Djoser’s default,
        # or override that too if you need to hide fields:
        'user': 'djoser.serializers.UserSerializer',
    },
    'TOKEN_MODEL': None, # Disable default Token auth
}
